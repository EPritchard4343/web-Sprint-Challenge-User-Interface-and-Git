...
Semantic HTML is what gives meaning to the information on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

With display: inline; the margin and paddings are not respected, display: block does nt add a line-break after the element so the elemt can sit next to other 
elements
...
git is valuable to developers because it allows multiple people to work on the same code simultaneously. It allows developers to have backups incase of too many bugs.
